...
//         }
//
//         private IEnumerable<Vector3> CreateMesh()
//         {
...
//                 d++;
//                 
//                 yield return new Vector3((_triangles[index] % widthVerts) * VertsSteps, BaseVertsHeight, (int)(_triangles[index] / widthVerts) * VertsSteps);
//                 yield return new Vector3((_triangles[index + 1] % widthVerts) * VertsSteps, BaseVertsHeight, (int)(_triangles[index + 1] /  widthVerts) * VertsSteps);
//                 yield return new Vector3((_triangles[index + 2] % widthVerts) * VertsSteps, BaseVertsHeight, (int)(_triangles[index + 2] /  widthVerts) * VertsSteps);
//                 // yield return new Vector3((int)(_triangles[index + 3] /  widthVerts + 1) * VertsSteps, BaseVertsHeight, (_triangles[index + 3] % heightVerts) * VertsSteps);
//                 // yield return new Vector3((int)(_triangles[index + 4]  / widthVerts + 1) * VertsSteps, BaseVertsHeight, (_triangles[index + 4] % heightVerts) * VertsSteps);
//                 yield return new Vector3((_triangles[index + 5] % widthVerts) * VertsSteps, BaseVertsHeight, (int)(_triangles[index + 5] /  widthVerts) * VertsSteps);
//             }
//         }
//
